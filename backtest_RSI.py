...
app.layout = html.Div([
                    html.H4('Relative Strength Index Strategy:'),
                    
                    html.P(['The relative strength index (RSI) is a momentum indicator used in technical analysis.',
                            html.Br(), 
                            'RSI measures the speed and magnitude of a security\'s recent price changes to evaluate overvalued or undervalued conditions in the price of that security over n days.', 
                            html.Br() ,
                            'A Trader decides the number of days, normally adjusted to the time frame of his/her analysis. The value of RSI can be a maximum of 100, \
                             and the minimum can be zero. Because the RSI oscillates between 0 and 100, it is mostly used to pinpoint when the security is \
                             oversold or overbought. A low reading indicates it has fallen in price thus might be oversold, and a high reading indicates it \
                             has risen and thus might signal it is overbought.',
                            html.Br() , 
                            ]),
...
@app.callback(
    ...
    [
     ...
     Input('upper_RSI','value'),
     Input('lower_RSI','value'),
     Input('backtest_days','value'),
    ])
def RSI_update(selected_stock,RSI_period,upper_RSI,lower_RSI,backtest_days):
